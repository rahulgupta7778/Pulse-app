  ...
  renderGoalList() {
    ...
    container.innerHTML = this._goals.map(g => {
      ...
      return `<div class="goal-card" data-id="${g.id}">
        ...
        ${g.location ? `<div class="task-location">📍 <a href="${MediaHelper.getMapsUrl(g.location)}" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">${g.location}</a></div>` : ''}
