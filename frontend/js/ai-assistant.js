const AIAssistant = {
  ...
  startVoice() {
    ...
    const topVoiceBtn = document.getElementById('voiceBtn');
    
    const setListeningState = (listening) => {
      if (listening) {
        voiceBtn?.classList.add('listening');
        topVoiceBtn?.classList.add('listening');
      } else {
        voiceBtn?.classList.remove('listening');
        topVoiceBtn?.classList.remove('listening');
      }
    };

    if (voiceBtn?.classList.contains('listening') || topVoiceBtn?.classList.contains('listening')) {
    ...
    this.addMessage("🎙️ Listening... tap the mic again to stop.", 'bot');
